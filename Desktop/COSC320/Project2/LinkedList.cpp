...
// asks the user if they would like to add each misspelled word to the Dictionary
void LinkedList::printAsk(Dictionary D) {
	ListNode *temp = head;
	std::string answer = "";

	while (temp) {
		std::cout << "\nWould you like to add the word, " << RED << temp->word << RESET << ", to the Dictionary? ";
		std::cin >> answer;
...
// finds all words within 1 or 2 edit-distances
int LinkedList::edits(Dictionary D) {	
	...
	while (temp) {
		...
		if (total->isEmpty()) {
			std::cout << "\n-------------------------------------------------------------" << std::endl;
			std::cout << "There are no suggestions available for " << RED << word << RESET << "." << std::endl;
		} else {
			std::cout << "\n-------------------------------------------------------------" << std::endl;
			std::cout << "Below are the words within one edit distance of " << RED << word << RESET << ". " << std::endl;
			...
			std::cout << "\n-------------------------------------------------------------" << std::endl;
			std::cout << "Below are the words within two edit distances of " << RED << word << RESET << ". " << std::endl;
			while(temp2) {
