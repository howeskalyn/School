...
# if $\bar{x}$ truly behaves as a normal distribution, this interval contains 95% of the probability mass
def confidence_interval(xbar):
    low = xbar - 1.96 * std(xbar)
    high = xbar + 1.96 * std(xbar)
    return [low, high]
