...
# Kalyn Howes
#
# This program is to get some experience with the GLSL shading language syntax and command library.
# The program is built on the StrangeShader example from the class. Make the following changes to the
# StrangeShader example.
#
# 3.14.22
