#! /usr/bin/env python3
#
# This program is a demo program for the basic setup for 3-D OpenGL lighting.  It
# incorporates classes for some standard geometric objects and attribute calculation.
# This version allows for the user to experiment with lighing attributes using a single
# light.  It incorporates the altering of the light position as well as spot light
# properties and attenuation.
#
# User Options - Keys
#
...
# - R: Resets the attenuation values to c = 1, l = 0, and q = 0.
# - 1-9: Selection of what object to draw.
...
#
# If the alt or X key is pressed the spherical camera
# that is attached to the light is altered:
#
...
#
# If the G key is pressed the spherical camera
# that is attached to the light's spot direction
# is altered:
#
# - Left: Increases the direction's theta value.
# - Right: Decreases the direction's theta value.
# - Up: Increases the direction's psi value.
# - Down: Decreases the direction's psi value.
# - H + Up: Decreases the light's spot cutoff.
# - H + Down: Increases the light's spot cutoff.
# - J + Up: Decreases the light's spot exponent.
# - J + Down: Increases the light's spot exponent.
#
# If the T key is pressed.
#
# - Y + Up: Decreases attenuation constant term.
# - Y + Down: Increases attenuation constant term.
# - U + Up: Decreases attenuation linear term.
# - U + Down: Increases attenuation linear term.
# - I + Up: Decreases attenuation quadratic term.
# - I + Down: Increases attenuation quadratic term.
#
# User Options - Mouse
#
# If the spherical camera is currently selected,
...
ProgramName = "Basic Lighting Example - Spotlight & Attenuation"
maxfps = 60
minMajor = 3
minMinor = 3
Width = 800
