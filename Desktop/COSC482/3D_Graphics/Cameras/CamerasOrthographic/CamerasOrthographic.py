...
# The projection and view matrices are multiplied and sent to a single matrix in the shader.
# The model matrix is also loaded to the shader and the matrix multiplication of the PV and model
# matrices are done at the shader level.  This version allows the toggling of perspective mode
# and projection mode.
#
# User Options - Keys
#
...
# - P: Toggles between orthographic and perspective projection.
...
ProgramName = "Cameras & Basic 3-D Setup Example #2"
maxfps = 60
minMajor = 3
minMinor = 3
Width = 800
