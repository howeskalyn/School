#! /usr/bin/env python3
#
# This program is a demo program for the basic setup for a height map using
# an overlay texture image to produce a (low-resolution) terrain.
#
# User Options - Keys
#
...
ProgramName = "Basic Texture Example - Terrain"
maxfps = 60
minMajor = 3
minMinor = 3
Width = 800
