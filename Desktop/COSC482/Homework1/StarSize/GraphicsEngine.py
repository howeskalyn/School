...
def constructTriangles(n, color, length):
    # ANGLE SET UP
    angles = []
...
class GraphicsEngine():
    ...
    def __init__(self):
        ...
        self.length = 0.5
        self.data = constructTriangles(self.numPoints, self.color, self.length)
        self.loadStarData(self.numPoints, self.color, self.length)
    ...
    def loadStarData(self, numPoints, color, length):
        self.data = constructTriangles(numPoints, color, length)
