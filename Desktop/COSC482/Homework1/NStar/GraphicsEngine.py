# COSC 482 Homework #1: 2-3
# Produces an n-point red star where n is chosen randomly between 5 and 15.
# Kalyn Howes
# 2.21.22
...
n = random.randint(5, 15) # number of points (per inner & outer)
# n = 20 # testing
...
while i < n:
    ...
    data.append(innerPoints[i - 1]) # using previous inner point, when i = 0, i = last index
