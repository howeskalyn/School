...
class Light():
    ...
    # Changes both the diffuse and specular portions of the light color.
    def changeColor(self, rgba):
        r = rgba[0]
        g = rgba[1]
        b = rgba[2]
        a = rgba[3]
        self.diffuse = glm.vec4(r, g, b, a)
        self.specular = glm.vec4(r, g, b, a)

        lightFactor = 0.5
        self.diffuse = lightFactor * self.diffuse
        self.specular = lightFactor * self.specular
