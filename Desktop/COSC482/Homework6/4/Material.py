...
class Material():
    ...
    def dullGreen(self):
        self.ambient = glm.vec4(0, 0.3, 0, 1)
        self.diffuse = glm.vec4(0, 0.4, 0, 1)
        self.specular = glm.vec4(0.3, 0.4, 0.3, 1)
        self.emission = glm.vec4(0, 0, 0, 1)
        self.shininess = 15

    def metallicBlue(self):
        self.ambient = glm.vec4(0, 0, 0.2, 1)
        self.diffuse = glm.vec4(0, 0, 0.4, 1)
        self.specular = glm.vec4(0.6, 0.6, 0.2, 1)
        self.emission = glm.vec4(0, 0, 0, 1)
        self.shininess = 15

    def Pewter2(self):
        self.ambient = glm.vec4(0.105882, 0.1, 0.113725, 1)
        self.diffuse = glm.vec4(0.3, 0.3, 0.3, 1)
        self.specular = glm.vec4(0.333333, 0.333333, 0.521569, 1)
        self.emission = glm.vec4(0, 0, 0, 1)
        self.shininess = 9.84615
    ...
    def glow(self, time):
        ...
        self.diffuse = glm.vec4(0, 0, 0.4, 1)
        self.specular = glm.vec4(0.6, 0.6, 0.2, 1)
        self.emission = glm.vec4(math.sin(time * 2 * math.pi), 0, 0, 1)
        #self.emission = glm.vec4(time, 0, 0, 1)
        self.shininess = 15
