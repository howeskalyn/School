...
class GraphicsEngine():
                ...
                if donuts == 0:
                    ...
                    for stacks in range(0, 8):
                        if stacks < 7:
                            ...
                            if stacks == self.activeGlow:
                                self.drawCylinder(randomchoice, 1.25 + u)

                        if stacks == 7:
                            if stacks == self.activeGlow:
                                self.drawCylinder(randomchoice, 1.75 + u)
    ...
    def drawCylinder(self, randomchoice, yheight):
        self.mat.Turquoise()
        self.mat.LoadMaterial(self.LightingShader, "Mat")
        ...
        if randomchoice == 0:
            cylindermodel = glm.translate(glm.vec3(5, yheight, -5))
