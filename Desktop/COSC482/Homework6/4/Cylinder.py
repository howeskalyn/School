# Cylinder object
#
# Creates the vertex and normal vector data for a cylinder object and
# loads the data to the graphics card.
#
# Kalyn Howes
# 4.13.22
...
class Cylinder():
    # Constructor
    def __init__(self, r=1, length=5, lon=20, lat=20,
    ...
    def set(self, r=1, length=5, lon=20, lat=20,
              begintheta=0, endtheta=2 * np.pi,
              beginpsi=-np.pi / 2, endpsi=np.pi / 2):
        self.r = r
        self.length = length
