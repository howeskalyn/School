...
// light sources @ same places as spheres:
light_source { <-6, 2.5, -4> color White}  
light_source { <2, 2.5, -4> color White}
light_source { <-6, 2.5, 3> color White}
light_source { <2, 2.5, 3> color White}
...
// CREST ADDITION
#declare crest = height_field {
    png "HouseDracula.png"
    smooth
    texture { T_Stone10 }
