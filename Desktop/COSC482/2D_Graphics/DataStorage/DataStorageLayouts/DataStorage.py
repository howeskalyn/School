#! /usr/bin/env python3
#
# This program shows a couple examples of standard data storage layouts.  The
# layout you use will depend on the structure of the data you are using and
# your particular application needs.  These load vertex positions and vertex colors
# to the card, as we progress further into computer graphics we will be adding
# other data items.
#
# Don Spickler
# 12/06/2021
...
ProgramName = "Data Storage Layout Examples"
maxfps = 60
minMajor = 3
minMinor = 3
Width = 800
