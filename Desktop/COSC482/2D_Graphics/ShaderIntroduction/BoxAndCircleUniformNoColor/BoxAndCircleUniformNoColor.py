...
# shader uniform matrices. The objects in this example do not include color
# information but allow the shader to determine the color of the object.
# This is similar to what we will be going when looking at lighting in 3D.
#
# Don Spickler
# 12/16/2021
...
ProgramName = "Uniform Variable Example #4"
maxfps = 60
minMajor = 3
minMinor = 3
Width = 800
