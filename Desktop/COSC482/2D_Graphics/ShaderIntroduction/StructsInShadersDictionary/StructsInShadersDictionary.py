...
# shader uniform matrices.  This version shows the use of structs in shaders
# and the communication of structure field informtion between the shader and the
# graphics engine.
#
# Don Spickler
# 12/06/2021
...
ProgramName = "Uniform Variables and Structs Example"
maxfps = 60
minMajor = 3
minMinor = 3
Width = 800
