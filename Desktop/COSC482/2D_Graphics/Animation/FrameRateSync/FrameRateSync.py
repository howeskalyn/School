...
# shader uniform matrices.  There is also a simple animation of a spinning
# rectangle with the rate locked to the frame rate.  Under 60 FPS or so the
# animation looks good but with higher FPS the animation is too quick.
#
# Don Spickler
# 12/9/2021
...
ProgramName = "Frame Rate Animation"
maxfps = 60
minMajor = 3
minMinor = 3
Width = 800
